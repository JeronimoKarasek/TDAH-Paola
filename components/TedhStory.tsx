...
/**
 * A história e o contexto do Tedhy — o coração emocional da marca.
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-secondary-100 text-secondary-700 rounded-full px-4 py-1.5 text-sm font-semibold mb-4">
            <Brain size={16} /> A história do Tedhy
          </div>
          ...
          <div className="space-y-4 text-gray-600 text-lg">
            <p>
              O Tedhy é um cérebro como o seu: cheio de ideias geniais, mil abas
            ...
            <p>
              Então o Tedhy colocou os óculos, arregaçou as mangas e criou o{" "}
